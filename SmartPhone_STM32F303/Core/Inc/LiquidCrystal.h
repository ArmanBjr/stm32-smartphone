 ...
 *
 *  Reused per plan section 3 ("LiquidCrystal.h/.c -- existing, reused").
 *  Ported into this project unmodified from the previous-project reference
 *  (ToDo/3/HangmanGame/Core/{Inc,Src}/LiquidCrystal.{h,c}).
 */
