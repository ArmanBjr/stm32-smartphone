 ...
 *
 *  Reused per plan section 3 -- ported unmodified from the previous-project
 *  reference (ToDo/3/HangmanGame/Core/Src/LiquidCrystal.c), which already
 *  drove this same HD44780 20x4 4-bit interface successfully.
 */
